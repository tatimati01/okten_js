...
for (const user of usersList) {
    ...
    divUser.append(userId,userName,userUsername,userEmail,userAddress,userPhone,userWebsite,userCompany)
    ...
    divUser.style.border = '2px solid red';
    divUser.style.padding = '20px';
    userAddress.style.border = '1px solid blue';
    userAddress.style.padding = '20px';
    addressGeo.style.border = '1px solid green';
    addressGeo.style.padding = '20px';
    userCompany.style.border = '1px solid orange';
    userCompany.style.padding = '20px';
}


// let divArray = document.createElement('div');
// document.body.appendChild(divArray);
// let recDivCreator = (startElement) => {
//     debugger;
//     for (let element of startElement) {
//         if (element.length ) {
//             let divElement = document.createElement('div');
//             divElement.innerText = element;
//             divArray.appendChild(divElement);
//         }
//         recDivCreator(element);
//     }
// }
//
// recDivCreator(usersList);