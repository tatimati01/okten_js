...
//     let divOfMember = document.createElement('div');
//     document.body.appendChild(divOfMember);
//     divOfMember.innerText = `${member.name} ${member.surname}`
//     divOfMember.classList.add('member');
//     divOfMember.style.borderBottom = '2px solid black'
// }
...
//     divSurname.innerText = member.surname;
//     let divAge = document.createElement('div');
//     divAge.innerText = member.age;
//     let divInfo = document.createElement('div');
//     divInfo.innerText = member.info;
//     let divPhoto = document.createElement('img');
//     divPhoto.src = member.photo;
//
...
for (const course of coursesArray) {
    ...
    divCourse.style.width = '200px';
    divCourse.style.background = 'lightblue';
    divCourse.style.borderRadius = '10px';
    divCourse.style.margin = '10px';
    divCourse.style.padding = '10px';
    ...
    divCourse.append(divTitle,divDuration,ulModules)
