...
// function maxNumberReturner (array) {
//     let maxNum = array[0];
...
// function minNumberReturner (array) {
//     let minNum = array[0];
...
//
// let someArray = [1,2,10];
// console.log(averageOfArray(someArray));


// - створити функцію яка приймає будь-яку кількість чисел, повертає найменьше, а виводить найбільше (Math використовувати заборонено);

// function minMaxReturher (array) {
//     let minNum = array[0];
//     let maxNum = array[0];
//     for (let arrayElement of array) {
//         if (arrayElement < minNum) {
...
//
// let someArray = [1,2,10];
// console.log(`Min number is ${minMaxReturher(someArray)}`);


// - створити функцію яка заповнює масив рандомними числами
// (цей код генерує рандомні числа в діапазоні від 0 до 100 - Math.round(Math.random()*100)) та виводить його.

// function arrayRandomizer (size) {
//     let arrayEmpty = [];
...
// function arrRandomizer2 (size, limit) {
//     let arrEmpty = [];
//     for (let i = 0; i < size; i++) {
